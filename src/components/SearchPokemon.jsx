function SearchPokemon({search}) {
  return (
    <div className="container flex mx-auto border rounded-2xl">
      <span className="p-2">
      ...
      <input type="text" onChange={(e) => search(e.target.value)} placeholder="Search pokemon here..." className="pr-2 focus:outline-none flex-1" />
    </div>
  )
}
